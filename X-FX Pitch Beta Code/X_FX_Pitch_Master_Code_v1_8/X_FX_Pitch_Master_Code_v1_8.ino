...
int d1 = 8;
  ...
  int led_status_leftgreen = led_dim;
  int led_status_rightblue1 = led_dim;
  int led_status_rightblue2 = led_dim;
  int led_status_rightred = led_dim;
  int led_status_rightgreen = led_dim;
...
void setup() 
  {
      ...
      pinMode(right_led_Ablue2, OUTPUT);
      pinMode(right_led_red, OUTPUT);
      pinMode(right_led_green, OUTPUT);
    
      Serial.begin(57600);
      Serial.print("XF-X Firmware v1.");
      Serial.println(ver);
