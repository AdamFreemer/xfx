...
#define Right_LED_Green 16
  ...
  // Button declarations
  Bounce LeftButtonBlue1 = Bounce(1, 5);  // 5 = 5 ms debounce time
  Bounce LeftButtonBlue2 = Bounce(2, 5);  
  Bounce LeftButtonRed = Bounce(3, 5);
  Bounce LeftButtonGreen = Bounce(4, 5);
  Bounce RightButtonBlue1 = Bounce(5, 5);
  Bounce RightButtonBlue2 = Bounce(6, 5);
  Bounce RightButtonRed = Bounce(7, 5);
  Bounce RightButtonGreen = Bounce(8, 5);
